...
class GeoidHeight(object):
    ...
    def __init__(self, name="egm2008-1.pgm"):
        self.offset = None
        self.scale = None
        # Initialize attributes used in cubic and non-cubic interpolation
        # [this should resolve the raised issue documented in
        # issues/geoid_undulation_GeoidHeight_noAttribute_t_debug.out]
