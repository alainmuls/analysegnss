...
void main(void)
{
        ...
        // AM DATA
        long double roota = 5153.66836929;
        long double toe = 129600.0;
        long double m0 = 2.41435991407;
        long double e = 0.0144467453938;
        long double delta_n = 4.4294702195e-9;
        long double smallomega = 0.86388340236;
        long double cus = 9.02265310287e-6;
        long double cuc = -1.71363353729e-7;
        long double crs = -2.25;
        long double crc = 203.75;
        long double cis = -1.06170773506e-7;
        long double cic = 1.210719347e-7;
        long double idot = -5.93596154234e-10;
        long double i0 = 0.960374867559;
        long double bigomega0 = 2.41435991407;
        long double earthrate = bOMEGAE84;
        long double bigomegadot = -7.59960226822e-9;
